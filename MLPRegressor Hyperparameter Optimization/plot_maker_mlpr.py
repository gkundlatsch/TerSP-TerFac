...
EXCEL_PATH = "mlp_5fold_performance.xlsx"  # sorted file exported by the training script
PNG_OUT    = "mlp_train_vs_test_r2_f2.png"
...
ax.set_title("Train vs. Test R\u00B2 by Architecture", fontsize=14)
ax.set_xticks(x)
...
ax.legend(
    loc='upper left',
    bbox_to_anchor=(0.0, -0.25),  # center it horizontally, push it down
